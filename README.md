...
GitHub Star 趋势监控看板。为任何 GitHub 组织提供仓库 Star 数据的自动采集、可视化与趋势分析。

部署到 [Vercel](https://vercel.com) + [Neon](https://neon.tech)，零服务器运维。

## 功能

- **Star 看板** — 趋势图表 + 排行榜，支持时间范围切换、搜索、可见性筛选、CSV 导出
- **监控管理** — 从 GitHub 同步组织仓库列表，按需开关监控
- **调度任务** — 仓库元信息同步、Star 快照采集，可通过后台独立开关控制
